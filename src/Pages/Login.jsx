    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-10 transform hover:scale-105 transition duration-300">
        ...
        <form>
          ...
          <button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-3 px-4 rounded-lg hover:from-blue-600 hover:to-purple-700 transition duration-300 transform hover:scale-105">Sign In</button>
        </form>
        <p className="mt-6 text-center text-gray-600">
          New here? <a href="/register" className="text-blue-500 hover:text-blue-600 font-semibold">Create an account</a>
        </p>
      </div>
    </div>
  )
